...
public class InstructorDetailAdd extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.saveInstructor:
                onSave(courseID);
                Toast.makeText(InstructorDetailAdd.this, "Instructor Saved", Toast.LENGTH_LONG).show();
                finish();
                return true;
            case R.id.deleteInstructor:
                Instructor instructor = new Instructor();
                onDelete(instructor);
                Toast.makeText(InstructorDetailAdd.this, "Instructor Deleted", Toast.LENGTH_LONG).show();
                finish();
                return true;
            case R.id.cancel:
                onBackPressed();

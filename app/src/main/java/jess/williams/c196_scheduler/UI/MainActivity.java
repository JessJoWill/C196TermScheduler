...
public class MainActivity extends AppCompatActivity {
    ...
    public void begin(View view) {
        ...
        Course_Note courseNote1 = new Course_Note(1, "9/24/22", "Lorem ipsum dolor sit amet consectetur adipiscing elit, urna consequat felis vehicula class ultricies mollis dictumst, aenean non a in donec nulla. Phasellus ante pellentesque erat cum risus consequat imperdiet aliquam, integer placerat et turpis mi eros nec lobortis taciti, vehicula nisl litora tellus ligula porttitor metus.");
        Course_Note courseNote2 = new Course_Note(2, "Course Note", "Note for Course 2");
        Course_Note courseNote3 = new Course_Note(3, "Note Subject", "Note for Course 3");
        Course_Note courseNote4 = new Course_Note(4,"Note Subject", "Note for Course 4");
        Course_Note courseNote5 = new Course_Note(5,"Note Subject", "Note for Course 5");
        Course_Note courseNote6 = new Course_Note(6,"Note Subject", "Note for Course 6");
        Course_Note courseNote7 = new Course_Note(7,"Note Subject", "Note for Course 7");
        Course_Note courseNote8 = new Course_Note(8,"Note Subject", "Note for Course 8");
        Course_Note courseNote9 = new Course_Note(9,"Note Subject", "Note for Course 9");
        Course_Note courseNote10 = new Course_Note(10,"Note Subject", "Note for Course 10");
        Course_Note courseNote11 = new Course_Note(11,"Note Subject", "Note for Course 11");
        Course_Note courseNote12 = new Course_Note(12,"Note Subject", "Note for Course 12");
